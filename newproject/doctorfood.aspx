<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctorfood.aspx.cs" Inherits="newproject.doctorfood" %>
          ...
          <asp:Panel ID="Panel1" runat="server" CssClass="panel">
              <div class="panel-header">
               ...
               <div class="panel-body">
                  ...
                  <asp:Button ID="Button1" runat="server" Text="GIVE FEEDBACK"  CssClass="btn btn-dark btn-lg text-light"  />
