<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="maipahe.aspx.cs" Inherits="newproject.maipahe" %>
...
<body class="text-center" style="background-image: url('https://localhost:44340/icon/doctor (1).png'); background-repeat: no-repeat; background-attachment: fixed; background-position: center center">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <asp:Button ID="Button3" runat="server" Text="Login" class="btn btn-primary btn-lg" OnClick="mylogin_click"/>
